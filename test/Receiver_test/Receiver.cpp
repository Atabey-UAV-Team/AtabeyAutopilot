...
const int Receiver::ROLL_PIN = 2;
const int Receiver::PITCH_PIN = 3;
const int Receiver::THROTTLE_PIN = 18;
const int Receiver::YAW_PIN = 19;

const int Receiver::MIN_PWM = 992;
const int Receiver::MAX_PWM = 1984;
