function [F0] = cost_ATABEY(Z, V_target)
    ...
    % Senin modelinde 4 girdi var: Aileron, Elevator, Rudder, Throttle
    X = Z(1:9);
    U = Z(10:14); 
    ...
    Q = [xdot;          % 1-9: Türevler sıfır olmalı (Denge durumu)
    ...
    % Ceza Ağırlık Matrisi (Şimdilik her şeye eşit ağırlık veriyoruz)
    H = diag(ones(1,14));
    % Toplam Maliyet
    F0 = Q' * H * Q;
end
